 ...
 */
@Autonomous(name="Red Loading Side Nine Artifact Auto", group="OpMode", preselectTeleOp="Red TeleOp")
//@Disabled
public class RedLoadingSideNineArtifactAuto extends CommandOpMode {

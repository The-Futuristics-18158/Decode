 ...
 */
@Autonomous(name="Red Loading Side Far Nine Artifact Auto", group="OpMode", preselectTeleOp="Red TeleOp")
//@Disabled
public class RedLoadingSideFarNineArtifactAuto extends CommandOpMode {

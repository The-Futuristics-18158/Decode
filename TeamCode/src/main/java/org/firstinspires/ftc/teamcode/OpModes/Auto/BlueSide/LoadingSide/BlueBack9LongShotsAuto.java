 ...
 */
@Autonomous(name="Blue Back 9 Long Shots", group="OpMode", preselectTeleOp="Blue TeleOp")
//@Disabled
public class BlueBack9LongShotsAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        else
        {
            ...
            new Back9LongShotsAuto().schedule();
        }

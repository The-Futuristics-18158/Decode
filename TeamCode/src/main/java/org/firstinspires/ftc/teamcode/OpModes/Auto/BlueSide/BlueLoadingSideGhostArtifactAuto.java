 ...
 */
@Autonomous(name="Blue Back Ghost Auto", group="OpMode", preselectTeleOp="Blue TeleOp")
//@Disabled
public class BlueLoadingSideGhostArtifactAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        else
        {
            ...
            new LoadingSideGhostAuto().schedule();
        }

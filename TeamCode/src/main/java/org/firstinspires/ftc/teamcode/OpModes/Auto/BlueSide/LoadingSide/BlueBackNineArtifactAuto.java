 ...
 */
@Autonomous(name="Blue Back Nine Artifact Auto", group="OpMode", preselectTeleOp="Blue TeleOp")
//@Disabled
public class BlueBackNineArtifactAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        else
        {
            ...
            new BackNineArtifactAuto().schedule();
        }

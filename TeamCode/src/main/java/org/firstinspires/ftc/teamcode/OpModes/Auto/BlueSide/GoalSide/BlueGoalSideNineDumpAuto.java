...
import org.firstinspires.ftc.teamcode.CommandGroups.AutoCommandGroups.GoalSide.GoalSideNineDumpAuto;
 ...
 */
@Autonomous(name="Blue Goal Side Nine Dump Auto", group="OpMode", preselectTeleOp="Blue TeleOp")
//@Disabled
public class BlueGoalSideNineDumpAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        else
        {
            ...
            new GoalSideNineDumpAuto().schedule();
        }

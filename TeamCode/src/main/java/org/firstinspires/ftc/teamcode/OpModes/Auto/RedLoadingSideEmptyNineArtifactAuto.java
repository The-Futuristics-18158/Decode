...
// */
//@Autonomous(name="Red Loading Side Empty Nine Artifact Auto", group="OpMode", preselectTeleOp="Red TeleOp")
////@Disabled
//public class RedLoadingSideEmptyNineArtifactAuto extends CommandOpMode {
//
